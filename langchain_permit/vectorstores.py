...
class LangchainPermitVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """LangchainPermit vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = LangchainPermitVectorStore(
                collection_name="foo",
