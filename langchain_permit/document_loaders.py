"""LangchainPermit document loader."""
...
class LangchainPermitLoader(BaseLoader):
    ...
    """
    LangchainPermit document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import LangchainPermitLoader

            loader = LangchainPermitLoader(
                # required params = ...
                # other params = ...
            )
