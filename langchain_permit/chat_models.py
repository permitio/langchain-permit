...
class ChatLangchainPermit(BaseChatModel):
    ...
    """LangchainPermit chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-permit`` and set environment variable ``PERMIT_API_KEY``.
    ...
    Key init args — completion params:
        model: str
            Name of LangchainPermit model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            LangchainPermit API key. If not passed in will be read from env var PERMIT_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatLangchainPermit.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatLangchainPermit.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatLangchainPermit supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatLangchainPermit supports async generation. Otherwise delete.
