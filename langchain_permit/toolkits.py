...
class LangchainPermitToolkit(BaseToolkit):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-permit import LangchainPermitToolkit

            toolkit = LangchainPermitToolkit(
                # ...
            )
